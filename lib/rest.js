...
function makeRequest(serverSettings, callback, postData) {
    var request = http.request(serverSettings, function (response) {
        ...
        response.on('end', function (stuff) {
            var error;
...
function formatServerSettings(url, ajaxSettings, type) {
...
/**
    ...
    @param {Object} [settings.headers] - specify headers
...
AGPipeline.adapters.Rest.prototype.read = function (options, callback) {
    ...
    return makeRequest(formatServerSettings(url, ajaxSettings, 'GET'), callback);
...
AGPipeline.adapters.Rest.prototype.save = function (data, options, callback) {
    ...
    return makeRequest(formatServerSettings(url, ajaxSettings, type), callback, data);
};
...
AGPipeline.adapters.Rest.prototype.remove = function (toRemove, options, callback) {
    ...
    return makeRequest(formatServerSettings(url, ajaxSettings, type), callback);
};
